...
9. Abre la página del manual para el comando ps y revisa para qué sirve la opción -aux.

10. Visualiza el contenido del archivo creado.

11. Usa el comando adecuado para mostrar el contenido de informe.txt por pantalla.

12. Cambia los permisos del archivo.

13. Da permisos de lectura y escritura al propietario, pero solo lectura al grupo y a otros usuarios.

14. Lista los procesos activos y localiza uno específico.

15. Usa el comando ps para ver los procesos en ejecución y localiza el identificador (PID) de un proceso concreto, por ejemplo nano (si sigue abierto).

16. Finaliza un proceso.

17. Usa el comando apropiado para terminar el proceso identificado en el paso anterior.

18. Elimina un archivo y un directorio.

19. Borra el archivo informe.txt y, luego, elimina completamente el directorio proyecto_linux con todo su contenido.